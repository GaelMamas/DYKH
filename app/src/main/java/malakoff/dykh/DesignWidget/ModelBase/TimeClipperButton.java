...
public class TimeClipperButton extends View implements OnClickDetectArcListener {
    ...
    private void initByAttributes(TypedArray attributes) {
        ...
        final float default_progress_angle = 10;
        final int default_inner_arc_number = 4;
        final int default_circle_color = Color.WHITE;
        final int default_progress_color = Color.BLUE;
                ...
                if (shouldDraw) {
                    ...
                    try {
                        ...
                        if (mTimeCounter < 0) {
                            ...
                            setProgressAngle(mTimeCounter % Constants.ANGLE_MAX);
    ...
    public void setDisplay(boolean isNormalStyle) {
        if(isNormalStyle){
